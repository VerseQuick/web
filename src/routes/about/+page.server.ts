...
export const load: PageServerLoad = () => {
	...
	const aboutPoints = [
		...
		`Everything on this site is <a class="underline text-blue-600" target="blank" href="https://github.com/VerseQuick/web">open sourced</a>. Forking and self hosting is not only allowed, but encouraged.`,
